...
const ServerRules = (props) => {
  ...
  and to do that we need responsible` players.</p>
        ...
        <p>If your found breaking the above, you will be kicked off the server. Repeated offences will result in a ban.</p>
        <p>
          <b>For ease of communication please speak english in the presence of INF Members!</b>
        </p>
        <p>
          We hope our servers deliver the experience you are looking for, any suggestions to make our servers more enjoyable for you
          just leave a post and we will take it seriously.
        </p>
        <p>
